...
pub fn run() {
    ...
    let app = builder.invoke_handler(tauri::generate_handler![
                ...
                windows::screenshot_window::hide_screenshot_window,
                windows::screenshot_window::set_cursor_position_physical,
                windows::screenshot_window::get_settings,
                windows::screenshot_window::start_auto_selection,
                windows::screenshot_window::stop_auto_selection,
                windows::screenshot_window::init_scrolling_screenshot,
                windows::screenshot_window::start_scrolling_screenshot,
                windows::screenshot_window::pause_scrolling_screenshot,
                windows::screenshot_window::resume_scrolling_screenshot,
                windows::screenshot_window::stop_scrolling_screenshot,
                windows::screenshot_window::cancel_scrolling_screenshot,
                windows::screenshot_window::update_scrolling_panel_rect,
                windows::screenshot_window::create_pin_image_window,
