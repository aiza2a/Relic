...
function SidebarButton({
  ...
  `} style={{
      ...
      {/* 粒子效果 */}
      {uiAnimationEnabled && particles.map(particle => <div key={particle.id} className="absolute top-1/2 left-6 w-1.5 h-1.5 rounded-full bg-accent pointer-events-none" style={{
