  ...
  theme: {
    colors: {
      ...
      bg: {
        ...
        // 动态主题色
        dynamic: {
          primary: 'var(--bg-dynamic-primary, #d68d98)',
          hover: 'var(--bg-dynamic-hover, #c2747f)',
          light: 'var(--bg-dynamic-light, #f7edef)',
          dark: 'var(--bg-dynamic-dark, #b56b76)',
        },
        // 主题强调色（跟随 --qc-accent，深浅主题自动适配）
        accent: {
          DEFAULT: 'var(--qc-accent, #d68d98)',
          hover: 'var(--qc-accent-hover, #c2747f)',
          soft: 'var(--qc-active, rgba(214, 141, 152, 0.16))',
        },
      },
    },
  },
